<?php
/*
Plugin Name: WP HTML5 Location Selector
Plugin URI: http://www.fullondesign.co.uk/projects/wp-html5-category-selector-wordpress-plugin
Description: Adds a filter input field to the Location box on the add/edit post page. Originally designed to filter categories and modified by DH
Version: 1.0.2
