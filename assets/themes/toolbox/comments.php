...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php
				printf( _n( 'Comments (1)', 'Comments (%1$s)', get_comments_number(), 'toolbox' ),
		...
		<nav id="comment-nav-above">
			<h1 class="assistive-text section-heading visuallyhidden"><?php _e( 'Comment navigation', 'toolbox' ); ?></h1>
